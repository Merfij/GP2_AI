...
public class EnemyFSM_Stunable : MonoBehaviour, IStunnable
{
    [Header("FOV Settings")]
    public float radius;
    ...
    private void Awake()
    {
        ...
        player = target.GetComponent<NPCTarget>();
    ...
    void Update()
    {
        ...
        //    isStunned = false;
        //}
        if (!player.useLightBeam && currentState == EnemyState.Electrocuted)
        {
            ResumeEnemy();
        }
    }
